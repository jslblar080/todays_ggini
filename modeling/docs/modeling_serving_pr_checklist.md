...
- `python -m py_compile modeling/api/server.py`
- `python -m py_compile modeling/experiments/contract/run_modeling_api_http_smoke.py`
- `python -m py_compile modeling/tests/api/test_modeling_api_rag_error_status.py`

RAG 상태 코드 매핑 검증:

- `PYTHONPATH=modeling python modeling/tests/api/test_modeling_api_rag_error_status.py`
...
- `docker run --rm todays-ggini-modeling:ci python modeling/tests/api/test_modeling_api_rag_error_status.py`
