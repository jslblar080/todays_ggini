...
위 함수는 modeling/services/modeling_service.py에 위치한다.
...
PYTHONPATH=modeling python modeling/experiments/contract/validate_backend_contract_requests.py
...
python -m py_compile modeling/experiments/contract/validate_backend_contract_requests.py modeling/experiments/contract/validate_backend_contract_responses.py modeling/experiments/contract/run_backend_contract_validation.py
...
PYTHONPATH=modeling:modeling/experiments/contract python modeling/experiments/contract/run_modeling_service_contract_smoke.py --run-service
