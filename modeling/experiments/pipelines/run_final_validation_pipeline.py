...
DEFAULT_RESULT_OUTPUT = (
    "modeling/experiments/results/final_validation_result.json"
)
DEFAULT_SUMMARY_OUTPUT = (
    "modeling/experiments/results/final_validation_summary.json"
)
DEFAULT_CSV_OUTPUT = (
    "modeling/experiments/results/final_validation_summary.csv"
)
...
def print_summary(summary_path: str) -> None:
    ...
    keys = [
        ...
        "optimizer_infeasible_policy_event_rate",
        "optimizer_infeasible_constraint_type_count",
        "optimizer_infeasible_action_type_count",
        "required_meal_count",
        "selected_menu_count",
        "meal_coverage_rate",
...
def main() -> None:
    ...
    run_command([
        sys.executable,
        "modeling/experiments/analysis/analyze_final_validation_result.py",
        "--input",
        args.result_output,
        "--output-json",
        args.summary_output,
