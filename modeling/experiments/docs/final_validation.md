...
기본 출력 파일은 다음과 같다.
    ...
    modeling/experiments/results/final_validation_user_stability_result.json
    modeling/experiments/results/final_validation_user_stability_summary.json
    modeling/experiments/results/final_validation_user_stability_summary.csv
...
shell script를 사용하지 않고 직접 실행할 수도 있다.
    ...
    PYTHONPATH=modeling python modeling/experiments/pipelines/run_final_validation_pipeline.py \
      --scenario-file modeling/experiments/scenarios/style_validation_user_stability_scenarios.json \
      --result-output modeling/experiments/results/final_validation_user_stability_result.json \
      --summary-output modeling/experiments/results/final_validation_user_stability_summary.json \
      --csv-output modeling/experiments/results/final_validation_user_stability_summary.csv
