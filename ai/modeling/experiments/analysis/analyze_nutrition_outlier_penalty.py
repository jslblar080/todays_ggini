...
DEFAULT_INPUT_PATH = (
    "ai/modeling/experiments/results/ortools_default_policy_compare_result.json"
)

DEFAULT_OUTPUT_JSON_PATH = (
    "ai/modeling/experiments/results/nutrition_outlier_penalty_summary.json"
)

DEFAULT_OUTPUT_CSV_PATH = (
    "ai/modeling/experiments/results/nutrition_outlier_penalty_summary.csv"
)
