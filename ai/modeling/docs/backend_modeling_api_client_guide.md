...
- Request fixture: `ai/modeling/experiments/fixtures/backend_style_candidates_request.json`
- Response fixture: `ai/modeling/experiments/fixtures/backend_style_candidates_response.json`

curl 예시:

- `curl -s -X POST http://localhost:8001/meal-style-candidates -H "Content-Type: application/json" -H "X-API-Key: local-secret-key" --data-binary @ai/modeling/experiments/fixtures/backend_style_candidates_request.json | python -m json.tool`
...
- Header: `X-API-Key: local-secret-key`
- Request fixture: `ai/modeling/experiments/fixtures/backend_monthly_plan_request.json`
- Success response fixture: `ai/modeling/experiments/fixtures/backend_monthly_plan_success_response.json`
- Failure response fixture: `ai/modeling/experiments/fixtures/backend_monthly_plan_failure_response.json`

curl 예시:

- `curl -s -o /tmp/modeling_monthly_response.json -w "http_status=%{http_code}\n" -X POST http://localhost:8001/monthly-plan -H "Content-Type: application/json" -H "X-API-Key: local-secret-key" --data-binary @ai/modeling/experiments/fixtures/backend_monthly_plan_request.json`
