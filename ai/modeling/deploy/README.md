...
- cp ai/modeling/deploy/env.modeling.example ai/modeling/deploy/.env.modeling.prod
...
- docker compose --env-file ai/modeling/deploy/.env.modeling.prod -f ai/modeling/deploy/docker-compose.ec2.yml up -d --build
...
- sudo cp ai/modeling/deploy/nginx-modeling-api.conf.example /etc/nginx/sites-available/modeling-api
...
- docker compose --env-file ai/modeling/deploy/.env.modeling.prod -f ai/modeling/deploy/docker-compose.ec2.yml down
...
### 외부 배포 검증
    ...
    ./ai/modeling/deploy/scripts/verify_https_deployment.sh
